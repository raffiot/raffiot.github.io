var diseases_info = '<div id="diseases" class="info-p">'
		 + ' <p>This dataset is composed by every wikipedia pages that are at depth 2 from <a href="https://en.wikipedia.org/wiki/Category:Lists_of_diseases">disease</a> wikipedia page. <br />'
		 ...
		 +'</ul>'
		 +'<center>'
		 +'<img src="./images/diseases_overview.png" alt="visualisation preview">'
		 +'</center>'
		 +'<br/>'
		 +'<center>'
...
var wikispedia_info = '<div id="wikispedia" class="info-p">'
					 ...
					 +'</ul>'			
					 +'<center>'
					 +'<img src="./images/wikispedia_overview.png" alt="visualisation preview" >'
					 +'</center>'
					 +'<br/>'
					 +'<center>'
...
var century_info = '<div id="XX_century" class="info-p">'
				 +'<p>This dataset is composed by every wikipedia pages that are at depth 2 from <a href="https://en.wikipedia.org/wiki/Category:20th_century">XX century</a> wikipedia page <br />'
				 ...
				 +'</ul>'
				 +'<center>'
				 +'<img src="./images/XX_century_overview.png" alt="visualisation preview" >'
				 +'</center>'
				 +'<br/>'
				 +'<center>'
